...
# The shared suite currently projects 742 deterministic cases through the console, xUnit, and NUnit runners.
```
...
- `COMPATIBILITY.md` is the per-revision MCP compatibility matrix (transports, remaining violations, relaxations, optional features); update it with every release after the specification review
