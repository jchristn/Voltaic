...
| Date | Who | Entry |
|---|---|---|
| 2026-09-24 | Isis investigation | Plan written. Root cause confirmed against Voltaic 0.6.1 and 0.7.1 with Claude Code 2.1.281 (debug log shows `tools/list failed ... missing required resultType`). Live Isis at `view.homedns.org:8720` negotiates `2026-07-28` on `initialize` |
