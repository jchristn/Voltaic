                ...
                new List<TestCaseDescriptor>
                {
                    Case(suiteId, "ExportedTypesAreTracked", "Every exported Voltaic type is tracked by the test matrix", ct =>
                    {
                        ...
                        string[] expected =
                        {
                            ...
                            "Voltaic.Core.LoopbackAddresses",
                            "Voltaic.Core.MessageFraming",
                            "Voltaic.Core.OriginPolicy",
                            ...
                            "Voltaic.Mcp.McpResolvedVersion",
                            "Voltaic.Mcp.McpVersionResolver",
                            "Voltaic.Mcp.McpDiscoverResult",
                            "Voltaic.Mcp.McpInputRequest",
                            "Voltaic.Mcp.McpInputRequiredResult",
                            "Voltaic.Mcp.McpTask",
                            "Voltaic.Mcp.McpTaskStatus",
                            "Voltaic.Mcp.McpCreateTaskResult",
                            "Voltaic.Mcp.McpTaskAck",
                            "Voltaic.Mcp.McpUpdateTaskParams",
                            "Voltaic.Mcp.McpInCoreTask",
                            "Voltaic.Mcp.McpCreateInCoreTaskResult",
                            "Voltaic.Mcp.McpTaskAugmentation",
                            "Voltaic.Mcp.McpListTasksResult",
